  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-muted/40 px-6 py-20 text-center sm:px-8">
      ...
      <motion.h1
        ...
        className="mb-2 text-5xl font-extrabold text-foreground sm:text-6xl md:text-7xl"
      >
        404
      </motion.h1>
      ...
      <motion.h2
        ...
        className="mb-4 text-xl font-semibold text-muted-foreground sm:text-2xl md:text-3xl"
      >
