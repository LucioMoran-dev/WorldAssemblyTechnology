    ...
    <div className="space-y-8">
      ...
      <section id="definitions" className="space-y-4">
        ...
        <ul className="text-muted-foreground list-none space-y-2 text-sm">
          ...
          <li>
            ...
            realiza un pedido de compra de bienes o servicios de Shop.
          </li>
          <li>
            (c) &quot;Productos&quot; significa todos los bienes, materiales y
            servicios suministrados por Shop.
          </li>
          <li>
            (d) si el Cliente comprende más de una persona, cada una de esas
            personas es individual y solidariamente responsable.
          </li>
          <li>
            (e) las referencias a un partido incluyen a cualquier forma de
            entidad y sus respectivos sucesores, cesionarios y representantes
            permitidos.
          </li>
          <li>
            (f) las referencias a una persona incluyen a un individuo, la corona
            de cualquier reino, gobierno, entidad o corporación del Estado.
          </li>
          <li>
            (g) todas las referencias a la moneda son referencias a dólares
            australianos.
          </li>
        </ul>
      </section>
      ...
      <section id="general" className="space-y-4">
        ...
        <p className="text-muted-foreground text-sm">
          ...
          pedidos realizados en Internet, están sujetos a la aceptación por
          parte de Shop. La aceptación de los Términos y Condiciones constituye
          el acuerdo completo entre las partes. Shop se reserva el derecho de
          variar cualquiera de estos términos en cualquier momento y cualquier
          pedido posterior realizado por el Cliente y aceptado por Shop, el
          Cliente acuerda que continuará en aceptación de los términos y
          condiciones tal como están en ese momento. El Cliente también acuerda
          que tiene derecho a cancelar o variar el pedido en cualquier momento,
          según lo acordado por escrito por ambas partes.
        </p>
      </section>
      ...
      <section id="quotations" className="space-y-4">
        ...
        <p className="text-muted-foreground text-sm">
          ...
          validez de la cotización será de 30 días a partir de la fecha de la
          cotización. Por lo tanto, los precios indicados en la cotización
          pueden ser variados por Shop sin previo aviso al Cliente.
        </p>
      </section>
      ...
      <section id="prices" className="space-y-4">
        ...
        <p className="text-muted-foreground text-sm">
          ...
          plazo razonable. Los precios están sujetos a cambios sin previo aviso.
          Los precios minoristas recomendados se proporcionan solo como guía.
          Shop no tiene obligación de cumplir con esa recomendación. Si Shop
          acepta devolver los Productos que han sido suministrados, el Cliente
          acepta pagar cualquier reposición o cargo de manipulación impuesto por
          Shop y reembolsa a Shop el precio unitario cobrado por los bienes
          usados y puede ser enmendado para tener en cuenta cualquier variación
          en el precio de compra total del Cliente. Los precios incluyen el GST,
          pero no incluyen ninguna otra tarifa o impuesto, que además del precio
      ...
      <section id="credit-accounts" className="space-y-4">
        ...
        <p className="text-muted-foreground text-sm">
          ...
          el Cliente será notificado por escrito y la terminación entrará en
          vigencia al recibir esa notificación por parte del Cliente.
        </p>
      </section>
      ...
      <section id="change-ownership" className="space-y-4">
        ...
        <p className="text-muted-foreground text-sm">
          ...
          parcial, el Cliente debe proporcionar inmediatamente un aviso por
          escrito a Shop. El no proporcionar dicho aviso inmediato por escrito
          del cambio de propiedad constituirá un incumplimiento de estos
          términos y condiciones y Shop puede terminar el acuerdo de crédito
          comercial del Cliente y exigir el pago total de todas las facturas,
          cuentas no pagadas, intereses, daños, costos, cargos, tarifas y gastos
          incurridos o sufridos por Shop al tratar con cualquier persona
          (incluidos los agentes de cobranza, asignaciones, accionistas) o
          cualquier otra entidad (incluido un fideicomiso) que puede haber
        ...
        <p className="text-muted-foreground text-sm">
          ...
          propiedad del negocio para permitir que Shop tenga tiempo suficiente
          para contactar al banco del Cliente o una organización relacionada de
          tarjeta de crédito antes de cualquier cambio de propiedad o
      ...
      <section id="information" className="space-y-4">
        ...
        <p className="text-muted-foreground text-sm">
          ...
          están destinados a ser meramente una descripción general de los
          bienes, no están incorporados dentro de este acuerdo y no forman parte
          de la descripción de los bienes vendidos bajo este o cualquier otro
          acuerdo a menos que se acuerde lo contrario por escrito por Shop en
          cuyo caso dicha información estará sujeta al comercio reconocido.
        </p>
      </section>
      ...
      <section id="delivery" className="space-y-4">
        ...
        <p className="text-muted-foreground text-sm">
          ...
          para cumplir con arreglos especiales de entrega (es decir, entrega
          Tasmaniana / Northern Territory), o arreglos de entrega urgentes,
          estos costos adicionales pueden ser cobrados al Cliente y pueden
